...
<div class="content shrinker">
        ...
        <div class="content">
                ...
                @elseif($user[0]->clientType === 'business')
                    <span class="has-text-weight-bold">(Categories Applicable to Non-Individuals)</span>
                    <table class="table">
                        <tbody>
                            <tr>
                                <td>a)</td>
                                <td>
                                    @if($user[0]->bus_ck1 == 1)
                                    <div class="">&nbsp;&nbsp;<img src="{{ $user[0]->form_signature }}" alt="Form signature" width="120" height="120"></div>
                                    @endif
                                </td>
