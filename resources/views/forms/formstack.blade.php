                ...
                <div class="tile is-parent">
                    <div class="tile">
                        <article class="tile is-child box">
                            ...
                            <p>Person, (iv) any discretionary account or similar account (other than an estate or trust) held
                                by a dealer or other fiduciary organized, incorporated, or (if an individual) resident in
                                the United States, and (v) any partnership or corporation organized or incorporated under
                                the laws of any non-U.S. jurisdiction which is formed by a U.S. Person principally for the
                                purpose of investing in securities not registered under the 1933 Act.</p>
                            <div class="content">
                                <ol class="is-upper-roman">
                                    ...
                                    <ol class="is-lower-roman">
                                        <li>The Issuer represents, warrants and covenants that, as of the date given above and at the Closing:</li>
                                        <br>
                                        <b>(a)</b> the Issuer is a valid and subsisting limited partnership formed and in good standing under the laws of the Province of British Columbia;
                                        <br>
                                        <b>(b)</b> the Issuer has complied and will comply fully with the requirements of all applicable corporate and securities laws and administrative policies and directions, including, without limitation, the Acts and the Partnership Act (British Columbia) in relation to the issue and trading of its securities and in all matters relating to the Offering;
                                        <br>
                                        <b>(c)</b> there is not presently, and will not be until the closing of the Offering, any adverse material change, as defined in the Acts, relating to the Issuer or change in any material fact, as defined in the Acts, relating to any of the Units which has not been or will not be fully disclosed;
                                        <br>
                                        <b>(d)</b> the issue and sale of the Units by the Issuer does not and will not conflict with, and does not and will not result in a breach of, any of the terms of the Issuer’s constating documents or any agreement or instrument to which the Issuer is a party or by which it is bound;
                                        <br>
                                        <b>(e)</b> the Issuer is not a party to any actions, suits or proceedings which could materially affect its business or financial condition, and to the best of the Issuer’s knowledge no such actions, suits or proceedings are contemplated or have been threatened;
                                        <br>
                                        <b>(f)</b> this Agreement has been or will be by the Closing, duly authorized by all necessary corporate action on the part of the Issuer, and the Issuer has or will have by the Closing full corporate power and authority to undertake the Offering;
                                        <br>
                                        <b>(g)</b> the Issuer is not in default of any of the requirements of the Securities Act (British Columbia) or any of the administrative policies or notices of the applicable regulatory authorities;
                                        <br>
                                        <b>(h)</b> no order ceasing or suspending trading in securities of the Issuer nor prohibiting the sale of such securities has been issued to and is outstanding against the Issuer, the General Partner or its directors, officers or promoters or against any other companies that have common directors, officers or promoters and no investigations or proceedings for such purposes are pending or threatened;
                                        <br>
                                        <b>(i)</b> the Issuer will within the required time, file with the Commissions, any documents, reports and information, in the required form, required to be filed by applicable securities laws in connection with this offering, together with any applicable filing fees and other materials; and
                                        <br>
                                        <b>(j)</b> no person has any right, agreement or option, present or future, contingent or absolute, or any right capable of becoming such a right, agreement or option, for the issue or allotment of any unissued Units in the capital of the Issuer, or any other security convertible into or exchangeable for any such Units, or to require the Issuer to purchase, redeem or otherwise acquire any of the issued and outstanding Units in its capital.
                                        <br><br>
                                        <li>The representations and warranties contained in this section will survive the Closing for a period of one year.</li>
                                    ...
                                    <ol class="is-upper-roman">
                                        ...
                                        <li>CLOSING</li>
                                        <ol class="is-lower-roman">
                                            <li>Closings will occur from time to time at the discretion of the General Partner; provided that if a Closing does not occur on or before 30 days following receipt by the Issuer of this Subscription, or such later date as agreed to by the Issuer and the Subscriber, this Agreement will terminate and the Subscription Proceeds will be returned to the Subscriber without interest or deduction.  If the Subscriber’s representations and warranties are not true as of the Closing, or it fails to comply with its covenants through to the Closing, the Issuer may reject this subscription, notwithstanding any prior acceptance thereof, in which case such Subscriber’s subscription proceeds will be returned without interest or deduction.</li>
                                            <br>
                                            <li>Upon execution of this Agreement, the Subscriber will deliver to the Issuer: (a) this subscription form, duly executed; (b) a certified cheque, wire transfer or bank draft for the total price of the Subscriber’s Units made payable to the Issuer; and (c) such Appendices as are applicable to the Subscriber.</li>
                                            <br>
                                            <li>At Closing, the Issuer will hold on behalf of the Subscriber the certificates representing the Subscriber’s Units, registered in the manner stipulated by the Subscriber.</li>
                                    ...
                                    <ol class="is-upper-roman">
                                        ...
                                        <ol class="is-lower-roman">
                                            <li>The Subscriber understands and acknowledges that the Units will be subject to resale restrictions under the Acts, expiring four months and a day from the date the Issuer becomes a reporting issuer in any jurisdiction of Canada; the terms of which will be endorsed on the certificates representing the Units.</li>
                                            <br>
                                            <li>The Subscriber agrees to comply with such resale restrictions; and further acknowledges that:</li>
                                            <br> &nbsp;&nbsp;&nbsp;&nbsp;(i) the Issuer is not a reporting issuer in any jurisdiction, and has no intention of becoming a reporting issuer;
                                            <br> &nbsp;&nbsp;&nbsp;&nbsp;(ii) the Subscriber has been advised to consult its own independent legal advisor with respect to the applicable resale restrictions; and
                                            <br> &nbsp;&nbsp;&nbsp;&nbsp;(iii) the Subscriber is solely responsible for complying with such restrictions and the Issuer is not responsible for ensuring compliance by the Subscriber with the applicable resale restrictions.
                                        </ol>
                                    </ol>
                                    <br><br>
                                    <ol class="is-upper-roman">
                                        ...
                                        <br>
                                        <ol class="is-lower-roman">
                                            <li>The Subscriber represents and warrants that the funds representing the Subscription Price, which will be advanced by the Subscriber to the Issuer hereunder, will not represent proceeds of crime for the purposes of the Proceeds of Crime (Money Laundering) and Terrorist Financing Act (Canada) (the “PCMLTFA”) and the Subscriber acknowledges that the Issuer may in the future be required by law to disclose the Subscriber’s name and other information relating to this Subscription Agreement and the Subscriber’s subscription hereunder, on a confidential basis, pursuant to the PCMLTFA.  To the best of its knowledge (a) none of the subscription funds to be provided by the Subscriber (i) have been or will be derived from or related to any activity that is deemed criminal under the law of Canada, the United States, or any other jurisdiction, or (ii) are being tendered on behalf of a person or entity who has not been identified to the Subscriber, and (b) it shall promptly notify the Issuer if the Subscriber discovers that any of such representations ceases to be true, and to provide the Issuer with appropriate information in connection therewith.</li>
                                            <br>
                                        </ol>
                                    </ol>
                                    ...
                                    <ol class="is-upper-roman">
                                        ...
                                        <ol class="is-lower-roman">
                                            <li>Power of Attorney</li>
                                            <br>
                                            Each Subscriber irrevocably makes, constitutes and appoints the General Partner or its successors under the term of this Agreement, as his true and lawful attorney and agent (“Attorney”), with full power and authority in his name, place and stead for his use and benefit, to make, execute, swear to, acknowledge, deliver, record and file, on his behalf and on behalf of the Partnership, the following:
                                            <br>
                                            &nbsp;&nbsp;<b>(a)</b> execute (whether under seal or otherwise), swear to, acknowledge, deliver and record or file as and where required any and all of the following:
                                            <br>
                                            &nbsp;&nbsp;&nbsp;&nbsp;(i) this Agreement, the Certificate and any amendments to the Certificate required under the Act, and any other instrument required to form, qualify, continue and keep in good standing the Partnership as a limited partnership or otherwise to comply with the laws of any jurisdiction in which the Partnership may carry on business or own or have property in order to maintain the limited liability of the Limited Partners and to comply with the applicable laws of such jurisdiction;
                                            <br>
                                            &nbsp;&nbsp;&nbsp;&nbsp;(ii) any instruments, declarations and certificates, including amendments to the Certificate, necessary to reflect any amendment to this Agreement;
                                            <br>
                                            &nbsp;&nbsp;&nbsp;&nbsp;(iii) a certificate evidencing the termination of the Partnership and the other instruments or documents as may be deemed necessary or desirable by the General Partner upon the termination of the Business of the Partnership;
                                            <br>
                                            &nbsp;&nbsp;&nbsp;&nbsp;(iv) all conveyances, agreements and other instruments necessary or desirable to reflect the dissolution and termination of the Partnership including cancellation of any certificates or declarations and the execution of any elections under the Income Tax Act (Canada) as the same may be amended or re-enacted from time to time, and any analogous provincial legislation;
                                            <br>
                                            &nbsp;&nbsp;<b>(b)</b> execute, deliver and file with any governmental body or instrumentality thereof of the Government of Canada or a Province, any documents necessary to be filed with any governmental body, agency or authority in connection with the Business, property, assets and undertaking of the Partnership;
                                            <br>
                                            &nbsp;&nbsp;<b>(c)</b> execute, deliver and file any document on behalf of and in the name of the Partnership as may be necessary to give effect to the Business of the Partnership;
                                            <br>
                                            &nbsp;&nbsp;<b>(d)</b> execute and deliver transfer forms and such other documents and instruments on behalf of and in the name of the Limited Partner as may be necessary to give effect to the assignment, redemption or transfer of a Unit;
                                            <br>
                                            &nbsp;&nbsp;<b>(e)</b> execute, deliver and file all elections, determinations or designations under the Income Tax Act (Canada) or any other taxation or other legislation or laws of like import of Canada or of any provinces or any jurisdictions in respect of the affairs of the Partnership or of a Partner’s interest in the Partnership;
                                            <br>
                                            &nbsp;&nbsp;<b>(f)</b> execute and deliver all such other documents or instruments on behalf of and in the name of the Partnership and the Limited Partners or any of them as may be deemed necessary or desirable by the General Partner to carry out fully the provisions of a Subscription, this Agreement or any other material contract in accordance with its terms;
                                            <br>
                                            &nbsp;&nbsp;<b>(g)</b> amend this Agreement, and execute and deliver all such amendments, documents or instruments on behalf of and in the name of the Partnership and the Limited Partners as may be deemed necessary or desirable by the General Partner to amend this Agreement in accordance with its terms; and
                                            <br>
                                            &nbsp;&nbsp;<b>(h)</b> execute, deliver and file all such documents or instruments or behalf of and in the name of the Partnership and the Limited Partners or any of them as may be deemed necessary or desirable by the General Partner to dissolve, liquidate or terminate the Partnership as a limited partnership.
                                            <br><br>
                                            To evidence the foregoing, each Limited Partner, in executing a Subscription Form and/or a Transfer Form shall execute or confirm a Power of Attorney containing the powers set forth above.
                                            <br><br>
                                            <li>Irrevocability</li>
                                            <br><br>
                                            The grant of authority contained in Section 0 and the Power of Attorney:
                                            <br><br>
                                            &nbsp;&nbsp;<b>(a)</b> shall be coupled with an interest therein and shall be irrevocable and shall survive the death or incapacity of the Limited Partner granting the power;
                                            <br>
                                            &nbsp;&nbsp;<b>(b)</b> may be exercised by the General Partner on behalf of each Limited Partner executing any instrument with a single signature as attorney and agent for all of them;
                                            <br>
                                            &nbsp;&nbsp;<b>(c)</b> shall survive the delivery of an assignment by a Limited Partner of the whole or any portion of his Unit; and
                                            <br>
                                            &nbsp;&nbsp;<b>(d)</b> shall extend to and shall be binding upon the heirs, executors, administrators, legal personal representative, successors and assigns of a Limited Partner.
                                            <br><br>
                                            Each Limited Partner shall be bound by the Attorney when he is acting in good faith pursuant to the Power of Attorney and authority and each Limited Partner waives the defenses which may be available to him, to contest, negate or disaffirm the action of the Attorney taken in good faith in accordance with the terms of the Power of Attorney and authority.
                                        </ol>
                                    </ol>
                                    <ol class="is-upper-roman">
                                        <li>MISCELLANEOUS</li>
                                        <ol class="is-lower-roman">
                                            <br>
                                            <li>The Subscriber hereby authorizes the Issuer to correct any errors in, or complete any minor information missing from this Agreement and any Appendix which has been executed by the Subscriber and delivered to the Issuer.</li>
                                            <br>
                                            <li>The Subscriber agrees to be bound and governed by all the terms and conditions contained in the Partnership Agreement, accepts the benefits contained therein, and ratifies the Partnership Agreement.</li>
                                            <br>
                                            <li>This Agreement enures to the benefit of and is binding upon the Parties and, as the case may be, their respective heirs, executors, administrators and, successors.</li>
                                            <br>
                                            <li>A Party will give all notices or other written communications to the other Party by hand, delivery, registered mail addressed to such other Party’s respective address which is noted on the cover page of this Agreement, or by facsimile transmission, electronic mail, or other similar form of electronic communication.</li>
                                            <li>This Agreement may be executed in counterparts, each of which when delivered will be deemed to be an original and all of which together will constitute one and the same document and the Issuer will be entitled to rely on delivery by facsimile machine of an executed copy of this subscription, and acceptance by the Issuer of such facsimile copy will be equally effective to create a valid and binding agreement between the Subscriber and the Issuer as if the Issuer had accepted the subscription originally executed by the Subscriber.</li>
                                            <br>
                                        </ol>
